...
2. Python Cryptographic Authority x509.Certificate.tbs_certificate_bytes. https://cryptography.io/en/latest/x509/reference/#cryptography.x509.Certificate.tbs_certificate_bytes.
